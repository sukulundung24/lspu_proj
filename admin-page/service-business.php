		    ...
		    <div class="row">
		    	<div class="col-md-12">
		    		<div class="content-holder">
		    			<div class="row">
		    				<div class="col-md-6">
		    					<h3 style="margin:10px 0;">Business Affairs Office Question List</h3>
		    				</div>
		    				<div class="col-md-6">
		    					<a href="add-question.php?service_type=business" class="btn btn-success addbtn"><i class="glyphicon glyphicon-plus"></i> Add</a>
		    				</div>
		    			</div>
